...
2) deleted the determineDx function, since I think it's useless;
3) removed pizzasDiv variable from the loop;
...
/* moved variable outside of the loop to prevent it from recalling when unnecessary */
